...
Thread::Fork(VoidFunctionPtr func, void *arg)
{
    ...
    //close interrupt 原因: 保護Thread，不受atomicity operation影響其Synchronization
    //補充: 為甚麼執行atomic operation時，都必須 turn off interrupt?
    //ans: 在uni-core下，確保不會發生context switch，在當下只有一個thread對其進行讀寫 -> Synchronization
